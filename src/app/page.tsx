  ...
  return (
    <main>
      <div className="bg-zinc-950 min-h-screen flex items-center justify-center p-4">
        <div className="max-w-4xl w-full bg-zinc-900 p-8 rounded-lg shadow-xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-center gap-12">
            ...
            <div className="flex-1 text-center space-y-4">
              <h1 className="text-3xl font-bold">Olá, me chamo Geancarlo Bastos</h1>
              <p className="text-gray-300 text-lg">
                Tenho 25 anos e sou estudante de Análise e Desenvolvimento de Sistemas na FATEC Senac Pelotas.
              </p>
              <p className="text-gray-300 text-lg">
                Estou no 5º de 6 semestres, e infelizmente ainda não tive a oportunidade de estagiar na área.
                <br />
                Estou em busca de oportunidades para me desenvolver profissionalmente e pessoalmente, conto com o seu apoio.
              </p>
              <p className="text-gray-300 text-lg">
